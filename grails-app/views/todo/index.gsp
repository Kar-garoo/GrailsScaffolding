...
<body>
<a href="#list-todo" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="createdDate"
                              title="${message(code: 'todo.createdDate.label', default: 'Created Date')}"/>
            ...
            <g:sortableColumn property="completedDate"
                              title="${message(code: 'todo.completedDate.label', default: 'Completed Date')}"/>
        ...
        <g:each in="${todoInstanceList}" status="i" var="todoInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${todoInstance.id}">${fieldValue(bean: todoInstance, field: "name")}</g:link></td>
